        ...
        <div className="p-4 sm:p-7">
          ...
          <div className="mt-5">
            ...
            <form onSubmit={handleRegister}>
              ...
              <div>
                  <label className="block text-sm mb-2 dark:text-white">Your Name</label>
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="password" name="password" className="py-3 px-4 block w-full border-gray-400 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 border-2" required placeholder="Set Password"/>
                ...
                <div>
                  <label className="block text-sm mb-2 dark:text-white">Your Photo Url</label>
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    <label className="text-sm dark:text-white">Already have an account <Link to="/login" className="text-blue-600 decoration-2 hover:underline font-medium">Sign In here</Link></label>
                  </div>
                </div>
