                                ...
                                <div className="lg:col-span-4">
                                    <blockquote>
                                        ...
                                        <p className="text-xl text-left font-medium text-gray-800 lg:text-xl lg:leading-normal dark:text-gray-200">
                                            FoodSwapHub has been a game-changer for me. I've shared my surplus food, connected with like-minded food enthusiasts, and received delicious meals in times of need. It's a platform that truly brings communities together through the joy of sharing.
                                        </p>
                            ...
                            <div className="lg:grid lg:grid-cols-6 lg:gap-8 lg:items-center">
                                ...
                                <div className="lg:col-span-4">
                                    <blockquote>
                                        ...
                                        <p className="text-xl text-left font-medium text-gray-800 lg:text-xl lg:leading-normal dark:text-gray-200">
                                            I cant say enough about how FoodSwapHub has made a difference in my community. It's a platform that brings compassion and generosity to the forefront. The ability to share and request food has touched many lives. Highly recommended
                                        </p>
